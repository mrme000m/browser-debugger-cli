...
export const PROFILE_FIELDS: FieldSchema[] = [
  ...
  },
  {
    ...
    required: false,
    default: 'true',
    description: 'Enable canvas/WebGL/audio/client-rect noise (disable for stable returning-user identity).',
    example: 'false',
  },
  {
  ...
  },
  {
    ...
    required: false,
    default: 'null',
    description: 'JSON file path containing Playwright storage_state to pre-seed cookies/localStorage.',
